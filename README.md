...
This repo can be installed directly as an npm package. According to the [official doc](https://docs.npmjs.com/cli/v10/commands/npm-install)
...
For unknown reason, you might installed old version when installing from Github!
